  ...
  return (
    <div className="flex mt-5">
      ...
      <div className="px-2 md:px-6 flex-1">
        ...
        <div className="mt-5">
          <h1 className="font-bold text-xl md:text-2xl">Create new student</h1>
          <form className="space-y-10 mt-3" onSubmit={submit}>
            <div className="space-y-5">
              <div className="">
                ...
                />
                {displayError(newStudentErrors, "name")}
              </div>
              <div className="">
                <input
                  ref={emailRef}
              ...
              <div>
                ...
                {displayError(newStudentErrors, "subjectClasses")}
              </div>
            </div>
            {displayError(newStudentErrors)}
            <div className="">
              <input
